...
- [phionyx-eval-inspect](https://github.com/halvrenofviryel/phionyx-eval-inspect) — interoperability bridge: convert Phionyx envelope chains into [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) `.eval` evaluation logs (pinned schema; interop-only, no AISI endorsement claim)

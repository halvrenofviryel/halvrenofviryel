...
- AIREP Embedded Evaluation Profile (experimental companion profile, profile version 0.1): [canonical source](https://github.com/halvrenofviryel/ai-runtime-evidence-protocol/tree/main/spec/airep/v0.2/profiles/embedded-evaluation) · [Hugging Face dataset mirror](https://huggingface.co/datasets/phionyx/airep-embedded-evaluation-profile) · [exporter Space](https://huggingface.co/spaces/phionyx/airep-evaluation-evidence) — does not certify safety or evaluator independence
- Hugging Face collection: [Phionyx — Runtime Evidence & Measurement](https://huggingface.co/collections/phionyx/phionyx-runtime-evidence-and-measurement-6aa65830536927640b962c5a)

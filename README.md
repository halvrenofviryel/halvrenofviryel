...
- AIREP Embedded Evaluation Profile (experimental companion profile, profile version 0.1; canonical source in the AIREP repository above): [Hugging Face dataset mirror](https://huggingface.co/datasets/phionyx/airep-embedded-evaluation-profile) · [exporter Space](https://huggingface.co/spaces/phionyx/airep-evaluation-evidence) — does not certify safety or evaluator independence
